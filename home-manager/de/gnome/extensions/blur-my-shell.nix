    ...
    pipelines = with lib.hm.gvariant; [
      (mkDictionaryEntry ["pipeline_default" [
        ...
        (mkDictionaryEntry ["effects" (mkVariant [
            (mkVariant [
              ...
              (mkDictionaryEntry ["id" (mkVariant "effect_40343001790813")])
              (mkDictionaryEntry ["params" (mkVariant [
                  (mkDictionaryEntry ["color" (mkVariant [0.0 0.0 0.0 0.325])])
                ])
              ])
            ])
            (mkVariant [
              (mkDictionaryEntry ["type" (mkVariant "corner")])
              (mkDictionaryEntry ["id" (mkVariant "effect_34038989600041")])
              (mkDictionaryEntry ["params" (mkVariant [
                  (mkDictionaryEntry ["radius" (mkVariant 12)])
                ])
              ])
            ])
          ])
      ...
      (mkDictionaryEntry ["pipeline_default_rounded" [
        ...
        (mkDictionaryEntry ["effects" (mkVariant [
            (mkVariant [
              (mkDictionaryEntry ["type" (mkVariant "color")])
              (mkDictionaryEntry ["id" (mkVariant "effect_21748564481335")])
              (mkDictionaryEntry ["params" (mkVariant [
                  (mkDictionaryEntry ["color" (mkVariant [0.0 0.0 0.0 0.375])])
                ])
              ])
            ])
            (mkVariant [
