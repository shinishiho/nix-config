{
  dconf.settings = {
    ...
    "org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom4".command = "nautilus";
    "org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom4".name = "File Browser";
  };
}
